...
public class LobbyUIManager : MonoBehaviourPunCallbacks
{
    ...
    public void OnRefreshClicked()
    {
        ...
        {
            Debug.LogWarning($"⚠️ Henüz lobby’de değiliz (State: {PhotonNetwork.NetworkClientState}), bekle OnJoinedLobby’yu.");
        }
    }
    public void OnBackPressed()
    {
        if (PhotonNetwork.InRoom)
        {
            ...
            return; // Sahne geçişi callback'te olacak
        }
    ...
    {
        Debug.Log("✔ ConnectedToMaster – Lobby’ye katılıyorum.");
        PhotonNetwork.JoinLobby();
    }
}
